...
def run_sequential(args, logger):
    ...
    # Learner
    if args.learner=="fast_QLearner" or args.learner=="qplex_curiosity_vdn_learner" or args.learner=="td3_curiosity_learner":
    ...
    while runner.t_env <= args.t_max:
        ...
        if args.env == 'mmdp_game_1' and (runner.t_env - last_demo_T) / args.demo_interval >= 1.0 and buffer.can_sample(args.batch_size):
            ### demo
