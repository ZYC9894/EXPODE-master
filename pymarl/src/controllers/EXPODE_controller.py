...
class EXPODEMAC:
    def __init__(self, scheme, groups, args):
        ...
        self.atten_input_shape = self.input_shape
    ...
    def save_models(self, path, id):
        th.save(self.agent.state_dict(), "{}/agent_{}.th".format(path, id))

    def load_models(self, path, id):
        self.agent.load_state_dict(th.load("{}/agent_{}.th".format(path, id), map_location=lambda storage, loc: storage))
