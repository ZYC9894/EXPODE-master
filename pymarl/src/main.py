...
def _get_config_alg(params, arg_name, subfolder,map_name):
    ...
    if map_name=="3s5z_vs_3s6z":
        config_name="EXPODE_sc2_3s5z_vs_3s6z"
    elif map_name=="6h_vs_8z":
        config_name="EXPODE_sc2_6h_vs_8z"
    elif map_name=="corridor":
        config_name="EXPODE_sc2_corridor"
    elif map_name=="MMM2":
        config_name="EXPODE_sc2_MMM2"
    elif map_name=="2s3z":
        config_name="EXPODE_sc2_2s3z"
    elif map_name=="3s5z":
        config_name="EXPODE_sc2_3s5z"
    elif map_name=="3s_vs_5z":
        config_name="EXPODE_sc2_3s_vs_5z"
    elif map_name=="5m_vs_6m":
        config_name="EXPODE_sc2_5m_vs_6m"
    elif map_name=="origin":
        config_name="EXPODE_toygame"
